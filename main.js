...
// VARIABLES GLOBALES
// ================================
let editIndex = null; // índice de la actividad que se está editando
let activities = JSON.parse(localStorage.getItem("activities")) || []; // listado de actividades
...
// ================================
// FUNCION: RENDERIZAR ACTIVIDADES
// ================================
...
// ================================
// FUNCION: ESCAPAR HTML (seguridad)
// ================================
...
// ================================
// EVENTOS GLOBALES: BORRAR Y COMPLETADO
// ================================
